...
./examples/routing/simple-multicast-flooding.d \
...
./examples/routing/simple-multicast-flooding.o \
./examples/routing/simple-routing-ping6.o \
./examples/routing/static-routing-slash32.o 


# Each subdirectory must supply rules for building sources it contributes
examples/routing/%.o: ../examples/routing/%.cc examples/routing/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-examples-2f-routing

clean-examples-2f-routing:
	-$(RM) ./examples/routing/dynamic-global-routing.d ./examples/routing/dynamic-global-routing.o ./examples/routing/global-injection-slash32.d ./examples/routing/global-injection-slash32.o ./examples/routing/global-routing-multi-switch-plus-router.d ./examples/routing/global-routing-multi-switch-plus-router.o ./examples/routing/global-routing-slash32.d ./examples/routing/global-routing-slash32.o ./examples/routing/manet-routing-compare.d ./examples/routing/manet-routing-compare.o ./examples/routing/mixed-global-routing.d ./examples/routing/mixed-global-routing.o ./examples/routing/rip-simple-network.d ./examples/routing/rip-simple-network.o ./examples/routing/ripng-simple-network.d ./examples/routing/ripng-simple-network.o ./examples/routing/simple-alternate-routing.d ./examples/routing/simple-alternate-routing.o ./examples/routing/simple-global-routing.d ./examples/routing/simple-global-routing.o ./examples/routing/simple-multicast-flooding.d ./examples/routing/simple-multicast-flooding.o ./examples/routing/simple-routing-ping6.d ./examples/routing/simple-routing-ping6.o ./examples/routing/static-routing-slash32.d ./examples/routing/static-routing-slash32.o

.PHONY: clean-examples-2f-routing
