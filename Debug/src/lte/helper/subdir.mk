...
src/lte/helper/%.o: ../src/lte/helper/%.cc src/lte/helper/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lte-2f-helper

clean-src-2f-lte-2f-helper:
	-$(RM) ./src/lte/helper/cc-helper.d ./src/lte/helper/cc-helper.o ./src/lte/helper/emu-epc-helper.d ./src/lte/helper/emu-epc-helper.o ./src/lte/helper/epc-helper.d ./src/lte/helper/epc-helper.o ./src/lte/helper/lte-global-pathloss-database.d ./src/lte/helper/lte-global-pathloss-database.o ./src/lte/helper/lte-helper.d ./src/lte/helper/lte-helper.o ./src/lte/helper/lte-hex-grid-enb-topology-helper.d ./src/lte/helper/lte-hex-grid-enb-topology-helper.o ./src/lte/helper/lte-stats-calculator.d ./src/lte/helper/lte-stats-calculator.o ./src/lte/helper/mac-stats-calculator.d ./src/lte/helper/mac-stats-calculator.o ./src/lte/helper/no-backhaul-epc-helper.d ./src/lte/helper/no-backhaul-epc-helper.o ./src/lte/helper/phy-rx-stats-calculator.d ./src/lte/helper/phy-rx-stats-calculator.o ./src/lte/helper/phy-stats-calculator.d ./src/lte/helper/phy-stats-calculator.o ./src/lte/helper/phy-tx-stats-calculator.d ./src/lte/helper/phy-tx-stats-calculator.o ./src/lte/helper/point-to-point-epc-helper.d ./src/lte/helper/point-to-point-epc-helper.o ./src/lte/helper/radio-bearer-stats-calculator.d ./src/lte/helper/radio-bearer-stats-calculator.o ./src/lte/helper/radio-bearer-stats-connector.d ./src/lte/helper/radio-bearer-stats-connector.o ./src/lte/helper/radio-environment-map-helper.d ./src/lte/helper/radio-environment-map-helper.o

.PHONY: clean-src-2f-lte-2f-helper
