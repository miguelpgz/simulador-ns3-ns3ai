...
src/config-store/model/%.o: ../src/config-store/model/%.cc src/config-store/model/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-config-2d-store-2f-model

clean-src-2f-config-2d-store-2f-model:
	-$(RM) ./src/config-store/model/attribute-default-iterator.d ./src/config-store/model/attribute-default-iterator.o ./src/config-store/model/attribute-iterator.d ./src/config-store/model/attribute-iterator.o ./src/config-store/model/config-store.d ./src/config-store/model/config-store.o ./src/config-store/model/display-functions.d ./src/config-store/model/display-functions.o ./src/config-store/model/file-config.d ./src/config-store/model/file-config.o ./src/config-store/model/gtk-config-store.d ./src/config-store/model/gtk-config-store.o ./src/config-store/model/model-node-creator.d ./src/config-store/model/model-node-creator.o ./src/config-store/model/model-typeid-creator.d ./src/config-store/model/model-typeid-creator.o ./src/config-store/model/raw-text-config.d ./src/config-store/model/raw-text-config.o ./src/config-store/model/xml-config.d ./src/config-store/model/xml-config.o

.PHONY: clean-src-2f-config-2d-store-2f-model
