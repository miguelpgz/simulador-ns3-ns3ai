...
src/mobility/model/%.o: ../src/mobility/model/%.cc src/mobility/model/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-mobility-2f-model

clean-src-2f-mobility-2f-model:
	-$(RM) ./src/mobility/model/box.d ./src/mobility/model/box.o ./src/mobility/model/constant-acceleration-mobility-model.d ./src/mobility/model/constant-acceleration-mobility-model.o ./src/mobility/model/constant-position-mobility-model.d ./src/mobility/model/constant-position-mobility-model.o ./src/mobility/model/constant-velocity-helper.d ./src/mobility/model/constant-velocity-helper.o ./src/mobility/model/constant-velocity-mobility-model.d ./src/mobility/model/constant-velocity-mobility-model.o ./src/mobility/model/gauss-markov-mobility-model.d ./src/mobility/model/gauss-markov-mobility-model.o ./src/mobility/model/geographic-positions.d ./src/mobility/model/geographic-positions.o ./src/mobility/model/hierarchical-mobility-model.d ./src/mobility/model/hierarchical-mobility-model.o ./src/mobility/model/mobility-model.d ./src/mobility/model/mobility-model.o ./src/mobility/model/position-allocator.d ./src/mobility/model/position-allocator.o ./src/mobility/model/random-direction-2d-mobility-model.d ./src/mobility/model/random-direction-2d-mobility-model.o ./src/mobility/model/random-walk-2d-mobility-model.d ./src/mobility/model/random-walk-2d-mobility-model.o ./src/mobility/model/random-waypoint-mobility-model.d ./src/mobility/model/random-waypoint-mobility-model.o ./src/mobility/model/rectangle.d ./src/mobility/model/rectangle.o ./src/mobility/model/steady-state-random-waypoint-mobility-model.d ./src/mobility/model/steady-state-random-waypoint-mobility-model.o ./src/mobility/model/waypoint-mobility-model.d ./src/mobility/model/waypoint-mobility-model.o ./src/mobility/model/waypoint.d ./src/mobility/model/waypoint.o

.PHONY: clean-src-2f-mobility-2f-model
