...
src/csma/examples/%.o: ../src/csma/examples/%.cc src/csma/examples/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-csma-2f-examples

clean-src-2f-csma-2f-examples:
	-$(RM) ./src/csma/examples/csma-broadcast.d ./src/csma/examples/csma-broadcast.o ./src/csma/examples/csma-multicast.d ./src/csma/examples/csma-multicast.o ./src/csma/examples/csma-one-subnet.d ./src/csma/examples/csma-one-subnet.o ./src/csma/examples/csma-packet-socket.d ./src/csma/examples/csma-packet-socket.o ./src/csma/examples/csma-ping.d ./src/csma/examples/csma-ping.o ./src/csma/examples/csma-raw-ip-socket.d ./src/csma/examples/csma-raw-ip-socket.o

.PHONY: clean-src-2f-csma-2f-examples
