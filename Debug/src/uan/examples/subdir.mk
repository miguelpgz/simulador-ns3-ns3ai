...
src/uan/examples/%.o: ../src/uan/examples/%.cc src/uan/examples/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-uan-2f-examples

clean-src-2f-uan-2f-examples:
	-$(RM) ./src/uan/examples/uan-6lowpan-example.d ./src/uan/examples/uan-6lowpan-example.o ./src/uan/examples/uan-cw-example.d ./src/uan/examples/uan-cw-example.o ./src/uan/examples/uan-ipv4-example.d ./src/uan/examples/uan-ipv4-example.o ./src/uan/examples/uan-ipv6-example.d ./src/uan/examples/uan-ipv6-example.o ./src/uan/examples/uan-raw-example.d ./src/uan/examples/uan-raw-example.o ./src/uan/examples/uan-rc-example.d ./src/uan/examples/uan-rc-example.o

.PHONY: clean-src-2f-uan-2f-examples
