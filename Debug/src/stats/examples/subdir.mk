...
src/stats/examples/%.o: ../src/stats/examples/%.cc src/stats/examples/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-stats-2f-examples

clean-src-2f-stats-2f-examples:
	-$(RM) ./src/stats/examples/double-probe-example.d ./src/stats/examples/double-probe-example.o ./src/stats/examples/file-aggregator-example.d ./src/stats/examples/file-aggregator-example.o ./src/stats/examples/file-helper-example.d ./src/stats/examples/file-helper-example.o ./src/stats/examples/gnuplot-aggregator-example.d ./src/stats/examples/gnuplot-aggregator-example.o ./src/stats/examples/gnuplot-example.d ./src/stats/examples/gnuplot-example.o ./src/stats/examples/gnuplot-helper-example.d ./src/stats/examples/gnuplot-helper-example.o ./src/stats/examples/time-probe-example.d ./src/stats/examples/time-probe-example.o

.PHONY: clean-src-2f-stats-2f-examples
