...
src/stats/model/%.o: ../src/stats/model/%.cc src/stats/model/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-stats-2f-model

clean-src-2f-stats-2f-model:
	-$(RM) ./src/stats/model/boolean-probe.d ./src/stats/model/boolean-probe.o ./src/stats/model/data-calculator.d ./src/stats/model/data-calculator.o ./src/stats/model/data-collection-object.d ./src/stats/model/data-collection-object.o ./src/stats/model/data-collector.d ./src/stats/model/data-collector.o ./src/stats/model/data-output-interface.d ./src/stats/model/data-output-interface.o ./src/stats/model/double-probe.d ./src/stats/model/double-probe.o ./src/stats/model/file-aggregator.d ./src/stats/model/file-aggregator.o ./src/stats/model/get-wildcard-matches.d ./src/stats/model/get-wildcard-matches.o ./src/stats/model/gnuplot-aggregator.d ./src/stats/model/gnuplot-aggregator.o ./src/stats/model/gnuplot.d ./src/stats/model/gnuplot.o ./src/stats/model/histogram.d ./src/stats/model/histogram.o ./src/stats/model/omnet-data-output.d ./src/stats/model/omnet-data-output.o ./src/stats/model/probe.d ./src/stats/model/probe.o ./src/stats/model/sqlite-data-output.d ./src/stats/model/sqlite-data-output.o ./src/stats/model/sqlite-output.d ./src/stats/model/sqlite-output.o ./src/stats/model/time-data-calculators.d ./src/stats/model/time-data-calculators.o ./src/stats/model/time-probe.d ./src/stats/model/time-probe.o ./src/stats/model/time-series-adaptor.d ./src/stats/model/time-series-adaptor.o ./src/stats/model/uinteger-16-probe.d ./src/stats/model/uinteger-16-probe.o ./src/stats/model/uinteger-32-probe.d ./src/stats/model/uinteger-32-probe.o ./src/stats/model/uinteger-8-probe.d ./src/stats/model/uinteger-8-probe.o

.PHONY: clean-src-2f-stats-2f-model
