...
src/click/examples/%.o: ../src/click/examples/%.cc src/click/examples/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-click-2f-examples

clean-src-2f-click-2f-examples:
	-$(RM) ./src/click/examples/nsclick-defines.d ./src/click/examples/nsclick-defines.o ./src/click/examples/nsclick-raw-wlan.d ./src/click/examples/nsclick-raw-wlan.o ./src/click/examples/nsclick-routing.d ./src/click/examples/nsclick-routing.o ./src/click/examples/nsclick-simple-lan.d ./src/click/examples/nsclick-simple-lan.o ./src/click/examples/nsclick-udp-client-server-csma.d ./src/click/examples/nsclick-udp-client-server-csma.o ./src/click/examples/nsclick-udp-client-server-wifi.d ./src/click/examples/nsclick-udp-client-server-wifi.o

.PHONY: clean-src-2f-click-2f-examples
