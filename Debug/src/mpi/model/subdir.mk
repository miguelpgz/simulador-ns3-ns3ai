...
src/mpi/model/%.o: ../src/mpi/model/%.cc src/mpi/model/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-mpi-2f-model

clean-src-2f-mpi-2f-model:
	-$(RM) ./src/mpi/model/distributed-simulator-impl.d ./src/mpi/model/distributed-simulator-impl.o ./src/mpi/model/granted-time-window-mpi-interface.d ./src/mpi/model/granted-time-window-mpi-interface.o ./src/mpi/model/mpi-interface.d ./src/mpi/model/mpi-interface.o ./src/mpi/model/mpi-receiver.d ./src/mpi/model/mpi-receiver.o ./src/mpi/model/null-message-mpi-interface.d ./src/mpi/model/null-message-mpi-interface.o ./src/mpi/model/null-message-simulator-impl.d ./src/mpi/model/null-message-simulator-impl.o ./src/mpi/model/remote-channel-bundle-manager.d ./src/mpi/model/remote-channel-bundle-manager.o ./src/mpi/model/remote-channel-bundle.d ./src/mpi/model/remote-channel-bundle.o

.PHONY: clean-src-2f-mpi-2f-model
