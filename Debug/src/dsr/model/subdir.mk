...
src/dsr/model/%.o: ../src/dsr/model/%.cc src/dsr/model/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-dsr-2f-model

clean-src-2f-dsr-2f-model:
	-$(RM) ./src/dsr/model/dsr-errorbuff.d ./src/dsr/model/dsr-errorbuff.o ./src/dsr/model/dsr-fs-header.d ./src/dsr/model/dsr-fs-header.o ./src/dsr/model/dsr-gratuitous-reply-table.d ./src/dsr/model/dsr-gratuitous-reply-table.o ./src/dsr/model/dsr-maintain-buff.d ./src/dsr/model/dsr-maintain-buff.o ./src/dsr/model/dsr-network-queue.d ./src/dsr/model/dsr-network-queue.o ./src/dsr/model/dsr-option-header.d ./src/dsr/model/dsr-option-header.o ./src/dsr/model/dsr-options.d ./src/dsr/model/dsr-options.o ./src/dsr/model/dsr-passive-buff.d ./src/dsr/model/dsr-passive-buff.o ./src/dsr/model/dsr-rcache.d ./src/dsr/model/dsr-rcache.o ./src/dsr/model/dsr-routing.d ./src/dsr/model/dsr-routing.o ./src/dsr/model/dsr-rreq-table.d ./src/dsr/model/dsr-rreq-table.o ./src/dsr/model/dsr-rsendbuff.d ./src/dsr/model/dsr-rsendbuff.o

.PHONY: clean-src-2f-dsr-2f-model
