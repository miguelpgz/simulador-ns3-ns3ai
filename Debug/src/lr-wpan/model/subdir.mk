...
src/lr-wpan/model/%.o: ../src/lr-wpan/model/%.cc src/lr-wpan/model/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-lr-2d-wpan-2f-model

clean-src-2f-lr-2d-wpan-2f-model:
	-$(RM) ./src/lr-wpan/model/lr-wpan-csmaca.d ./src/lr-wpan/model/lr-wpan-csmaca.o ./src/lr-wpan/model/lr-wpan-error-model.d ./src/lr-wpan/model/lr-wpan-error-model.o ./src/lr-wpan/model/lr-wpan-fields.d ./src/lr-wpan/model/lr-wpan-fields.o ./src/lr-wpan/model/lr-wpan-interference-helper.d ./src/lr-wpan/model/lr-wpan-interference-helper.o ./src/lr-wpan/model/lr-wpan-lqi-tag.d ./src/lr-wpan/model/lr-wpan-lqi-tag.o ./src/lr-wpan/model/lr-wpan-mac-header.d ./src/lr-wpan/model/lr-wpan-mac-header.o ./src/lr-wpan/model/lr-wpan-mac-pl-headers.d ./src/lr-wpan/model/lr-wpan-mac-pl-headers.o ./src/lr-wpan/model/lr-wpan-mac-trailer.d ./src/lr-wpan/model/lr-wpan-mac-trailer.o ./src/lr-wpan/model/lr-wpan-mac.d ./src/lr-wpan/model/lr-wpan-mac.o ./src/lr-wpan/model/lr-wpan-net-device.d ./src/lr-wpan/model/lr-wpan-net-device.o ./src/lr-wpan/model/lr-wpan-phy.d ./src/lr-wpan/model/lr-wpan-phy.o ./src/lr-wpan/model/lr-wpan-spectrum-signal-parameters.d ./src/lr-wpan/model/lr-wpan-spectrum-signal-parameters.o ./src/lr-wpan/model/lr-wpan-spectrum-value-helper.d ./src/lr-wpan/model/lr-wpan-spectrum-value-helper.o

.PHONY: clean-src-2f-lr-2d-wpan-2f-model
