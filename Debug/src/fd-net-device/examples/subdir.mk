...
clean-src-2f-fd-2d-net-2d-device-2f-examples:
	-$(RM) ./src/fd-net-device/examples/dummy-network.d ./src/fd-net-device/examples/dummy-network.o ./src/fd-net-device/examples/fd-emu-onoff.d ./src/fd-net-device/examples/fd-emu-onoff.o ./src/fd-net-device/examples/fd-emu-ping.d ./src/fd-net-device/examples/fd-emu-ping.o ./src/fd-net-device/examples/fd-emu-send.d ./src/fd-net-device/examples/fd-emu-send.o ./src/fd-net-device/examples/fd-emu-tc.d ./src/fd-net-device/examples/fd-emu-tc.o ./src/fd-net-device/examples/fd-emu-udp-echo.d ./src/fd-net-device/examples/fd-emu-udp-echo.o ./src/fd-net-device/examples/fd-tap-ping.d ./src/fd-net-device/examples/fd-tap-ping.o ./src/fd-net-device/examples/fd-tap-ping6.d ./src/fd-net-device/examples/fd-tap-ping6.o ./src/fd-net-device/examples/fd2fd-onoff.d ./src/fd-net-device/examples/fd2fd-onoff.o ./src/fd-net-device/examples/realtime-dummy-network.d ./src/fd-net-device/examples/realtime-dummy-network.o ./src/fd-net-device/examples/realtime-fd2fd-onoff.d ./src/fd-net-device/examples/realtime-fd2fd-onoff.o
