...
src/olsr/test/%.o: ../src/olsr/test/%.cc src/olsr/test/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-olsr-2f-test

clean-src-2f-olsr-2f-test:
	-$(RM) ./src/olsr/test/bug780-test.d ./src/olsr/test/bug780-test.o ./src/olsr/test/hello-regression-test.d ./src/olsr/test/hello-regression-test.o ./src/olsr/test/olsr-header-test-suite.d ./src/olsr/test/olsr-header-test-suite.o ./src/olsr/test/olsr-routing-protocol-test-suite.d ./src/olsr/test/olsr-routing-protocol-test-suite.o ./src/olsr/test/regression-test-suite.d ./src/olsr/test/regression-test-suite.o ./src/olsr/test/tc-regression-test.d ./src/olsr/test/tc-regression-test.o

.PHONY: clean-src-2f-olsr-2f-test
