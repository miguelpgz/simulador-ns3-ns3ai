...
src/energy/model/%.o: ../src/energy/model/%.cc src/energy/model/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-energy-2f-model

clean-src-2f-energy-2f-model:
	-$(RM) ./src/energy/model/basic-energy-harvester.d ./src/energy/model/basic-energy-harvester.o ./src/energy/model/basic-energy-source.d ./src/energy/model/basic-energy-source.o ./src/energy/model/device-energy-model-container.d ./src/energy/model/device-energy-model-container.o ./src/energy/model/device-energy-model.d ./src/energy/model/device-energy-model.o ./src/energy/model/energy-harvester.d ./src/energy/model/energy-harvester.o ./src/energy/model/energy-source.d ./src/energy/model/energy-source.o ./src/energy/model/li-ion-energy-source.d ./src/energy/model/li-ion-energy-source.o ./src/energy/model/rv-battery-model.d ./src/energy/model/rv-battery-model.o ./src/energy/model/simple-device-energy-model.d ./src/energy/model/simple-device-energy-model.o

.PHONY: clean-src-2f-energy-2f-model
