...
src/energy/helper/%.o: ../src/energy/helper/%.cc src/energy/helper/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-energy-2f-helper

clean-src-2f-energy-2f-helper:
	-$(RM) ./src/energy/helper/basic-energy-harvester-helper.d ./src/energy/helper/basic-energy-harvester-helper.o ./src/energy/helper/basic-energy-source-helper.d ./src/energy/helper/basic-energy-source-helper.o ./src/energy/helper/energy-harvester-container.d ./src/energy/helper/energy-harvester-container.o ./src/energy/helper/energy-harvester-helper.d ./src/energy/helper/energy-harvester-helper.o ./src/energy/helper/energy-model-helper.d ./src/energy/helper/energy-model-helper.o ./src/energy/helper/energy-source-container.d ./src/energy/helper/energy-source-container.o ./src/energy/helper/li-ion-energy-source-helper.d ./src/energy/helper/li-ion-energy-source-helper.o ./src/energy/helper/rv-battery-model-helper.d ./src/energy/helper/rv-battery-model-helper.o

.PHONY: clean-src-2f-energy-2f-helper
