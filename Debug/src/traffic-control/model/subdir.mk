...
./src/traffic-control/model/fq-cobalt-queue-disc.d \
./src/traffic-control/model/fq-codel-queue-disc.d \
./src/traffic-control/model/fq-pie-queue-disc.d \
...
./src/traffic-control/model/fq-cobalt-queue-disc.o \
./src/traffic-control/model/fq-codel-queue-disc.o \
./src/traffic-control/model/fq-pie-queue-disc.o \
...
clean-src-2f-traffic-2d-control-2f-model:
	-$(RM) ./src/traffic-control/model/cobalt-queue-disc.d ./src/traffic-control/model/cobalt-queue-disc.o ./src/traffic-control/model/codel-queue-disc.d ./src/traffic-control/model/codel-queue-disc.o ./src/traffic-control/model/fifo-queue-disc.d ./src/traffic-control/model/fifo-queue-disc.o ./src/traffic-control/model/fq-cobalt-queue-disc.d ./src/traffic-control/model/fq-cobalt-queue-disc.o ./src/traffic-control/model/fq-codel-queue-disc.d ./src/traffic-control/model/fq-codel-queue-disc.o ./src/traffic-control/model/fq-pie-queue-disc.d ./src/traffic-control/model/fq-pie-queue-disc.o ./src/traffic-control/model/mq-queue-disc.d ./src/traffic-control/model/mq-queue-disc.o ./src/traffic-control/model/packet-filter.d ./src/traffic-control/model/packet-filter.o ./src/traffic-control/model/pfifo-fast-queue-disc.d ./src/traffic-control/model/pfifo-fast-queue-disc.o ./src/traffic-control/model/pie-queue-disc.d ./src/traffic-control/model/pie-queue-disc.o ./src/traffic-control/model/prio-queue-disc.d ./src/traffic-control/model/prio-queue-disc.o ./src/traffic-control/model/queue-disc.d ./src/traffic-control/model/queue-disc.o ./src/traffic-control/model/red-queue-disc.d ./src/traffic-control/model/red-queue-disc.o ./src/traffic-control/model/tbf-queue-disc.d ./src/traffic-control/model/tbf-queue-disc.o ./src/traffic-control/model/traffic-control-layer.d ./src/traffic-control/model/traffic-control-layer.o
