...
src/aodv/test/%.o: ../src/aodv/test/%.cc src/aodv/test/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-aodv-2f-test

clean-src-2f-aodv-2f-test:
	-$(RM) ./src/aodv/test/aodv-id-cache-test-suite.d ./src/aodv/test/aodv-id-cache-test-suite.o ./src/aodv/test/aodv-regression.d ./src/aodv/test/aodv-regression.o ./src/aodv/test/aodv-test-suite.d ./src/aodv/test/aodv-test-suite.o ./src/aodv/test/bug-772.d ./src/aodv/test/bug-772.o ./src/aodv/test/loopback.d ./src/aodv/test/loopback.o

.PHONY: clean-src-2f-aodv-2f-test
