...
src/mesh/model/%.o: ../src/mesh/model/%.cc src/mesh/model/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-mesh-2f-model

clean-src-2f-mesh-2f-model:
	-$(RM) ./src/mesh/model/mesh-information-element-vector.d ./src/mesh/model/mesh-information-element-vector.o ./src/mesh/model/mesh-l2-routing-protocol.d ./src/mesh/model/mesh-l2-routing-protocol.o ./src/mesh/model/mesh-point-device.d ./src/mesh/model/mesh-point-device.o ./src/mesh/model/mesh-wifi-beacon.d ./src/mesh/model/mesh-wifi-beacon.o ./src/mesh/model/mesh-wifi-interface-mac.d ./src/mesh/model/mesh-wifi-interface-mac.o

.PHONY: clean-src-2f-mesh-2f-model
