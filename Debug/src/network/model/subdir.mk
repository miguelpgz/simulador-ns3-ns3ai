...
clean-src-2f-network-2f-model:
	-$(RM) ./src/network/model/address.d ./src/network/model/address.o ./src/network/model/application.d ./src/network/model/application.o ./src/network/model/buffer.d ./src/network/model/buffer.o ./src/network/model/byte-tag-list.d ./src/network/model/byte-tag-list.o ./src/network/model/channel-list.d ./src/network/model/channel-list.o ./src/network/model/channel.d ./src/network/model/channel.o ./src/network/model/chunk.d ./src/network/model/chunk.o ./src/network/model/header.d ./src/network/model/header.o ./src/network/model/net-device.d ./src/network/model/net-device.o ./src/network/model/nix-vector.d ./src/network/model/nix-vector.o ./src/network/model/node-list.d ./src/network/model/node-list.o ./src/network/model/node.d ./src/network/model/node.o ./src/network/model/packet-metadata.d ./src/network/model/packet-metadata.o ./src/network/model/packet-tag-list.d ./src/network/model/packet-tag-list.o ./src/network/model/packet.d ./src/network/model/packet.o ./src/network/model/socket-factory.d ./src/network/model/socket-factory.o ./src/network/model/socket.d ./src/network/model/socket.o ./src/network/model/tag-buffer.d ./src/network/model/tag-buffer.o ./src/network/model/tag.d ./src/network/model/tag.o ./src/network/model/trailer.d ./src/network/model/trailer.o
