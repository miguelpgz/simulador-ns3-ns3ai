...
src/network/helper/%.o: ../src/network/helper/%.cc src/network/helper/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-network-2f-helper

clean-src-2f-network-2f-helper:
	-$(RM) ./src/network/helper/application-container.d ./src/network/helper/application-container.o ./src/network/helper/delay-jitter-estimation.d ./src/network/helper/delay-jitter-estimation.o ./src/network/helper/net-device-container.d ./src/network/helper/net-device-container.o ./src/network/helper/node-container.d ./src/network/helper/node-container.o ./src/network/helper/packet-socket-helper.d ./src/network/helper/packet-socket-helper.o ./src/network/helper/simple-net-device-helper.d ./src/network/helper/simple-net-device-helper.o ./src/network/helper/trace-helper.d ./src/network/helper/trace-helper.o

.PHONY: clean-src-2f-network-2f-helper
