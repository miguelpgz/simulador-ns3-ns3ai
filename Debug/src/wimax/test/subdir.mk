...
src/wimax/test/%.o: ../src/wimax/test/%.cc src/wimax/test/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-wimax-2f-test

clean-src-2f-wimax-2f-test:
	-$(RM) ./src/wimax/test/mac-messages-test.d ./src/wimax/test/mac-messages-test.o ./src/wimax/test/phy-test.d ./src/wimax/test/phy-test.o ./src/wimax/test/qos-test.d ./src/wimax/test/qos-test.o ./src/wimax/test/ss-mac-test.d ./src/wimax/test/ss-mac-test.o ./src/wimax/test/wimax-fragmentation-test.d ./src/wimax/test/wimax-fragmentation-test.o ./src/wimax/test/wimax-service-flow-test.d ./src/wimax/test/wimax-service-flow-test.o ./src/wimax/test/wimax-tlv-test.d ./src/wimax/test/wimax-tlv-test.o

.PHONY: clean-src-2f-wimax-2f-test
