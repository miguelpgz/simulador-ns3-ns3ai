...
# Cargar el modelo y el scaler, cambiar para cargar el modelo que se quiera usar
model_filename = '/home/pgz/Escritorio/simulador/simulador-ns3/modelos-ml/modelos-joblib/knn_model_newDataset.joblib'
scaler_filename = '/home/pgz/Escritorio/simulador/simulador-ns3/modelos-ml/modelos-joblib/scaler_knn_aux_newDataset.joblib'
...
def run_simulation(tam_red, num_stas, seed):
    ...
    try:
        ...
        while not rl.isFinish():
            with rl as data:
                ...
                row_data = [
                    ...
                    retransmission_per_packet, data.env.w, data.env.c, ns3Settings['tam_red'], ns3Settings['numStas']+1
                ]
                ...
                columns_to_normalize = data_df.columns.difference(['w','c','tam_red', 'num_stas','goodThroughput'])
        ...
        folder_path = f"results-memoria-logs/tam_red_{tam_red}/num_stas_{num_stas+1}"
